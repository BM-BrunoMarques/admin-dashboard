...
const SignIn: React.FC = () => {
  ...
  let emailAuthenticated: any;
  let passAuthenticated: any;
  const authenticate = () => {
    if (!emailAuthenticated) {
      emailAuthenticated = allUsers.find(
        (el) => el.authentication.email === emailLogin
      );
      if (!emailAuthenticated) {
        return false;
    ...
    return (passAuthenticated =
      emailAuthenticated.authentication.password === passLogin);
  };
